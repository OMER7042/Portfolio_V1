...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex flex-col lg:flex-row items-center gap-4 lg:gap-8">
        <div className="relative max-w-[600px] flex-shrink-0">
          {/* Badge */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
          ...
          >
            I build and deploy production-grade web applications with real
            users, real metrics, and real AI — integrating Gemini 2.0 across
            multiple projects on AWS and GCP.
          </motion.p>
        ...
        {/* sect */}
        {/* Right side — Tech Icon Cloud */}
        {/* <div className="hidden lg:flex flex-1 items-center justify-center h-[500px]">
          <TechCloud />
        </div> */}
        <div className="flex flex-1 items-center justify-center h-[280px] lg:h-[500px] w-full">
          <TechCloud />
        </div>
      </div>
    </section>
